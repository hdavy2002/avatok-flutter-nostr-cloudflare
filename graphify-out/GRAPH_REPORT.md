...
## Corpus Check
- 129 files · ~233,087 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1287 nodes · 2366 edges · 29 communities detected
...
Cohesion: 0.01
Nodes (228): add_contact_sheet.dart, ApiAuth, _eventId, h, _randomHex, _sha256Hex, _traceId, appByKey (+220 more)
...
Cohesion: 0.03
Nodes (89): handleAgent(), call(), hdr(), hx(), mk(), apnsConfigured(), b64url(), b64urlBytes() (+81 more)
...
Cohesion: 0.02
Nodes (107): api_auth.dart, _activeUser, _capture, ClerkClient, ClerkStep, ClerkUser, _deriveDomain, FlutterSecureStorage (+99 more)
...
Cohesion: 0.03
Nodes (73): copyWith, FlutterSecureStorage, Group, GroupStore, isAdmin, newId, _bigIntTo32, _bytesToBigInt (+65 more)
...
Cohesion: 0.04
Nodes (42): AvaLogo, _bare, _box, build, Center, _done, _eyeToggle, _footerLink (+34 more)
...
Cohesion: 0.06
Nodes (26): Avatar, build, Container, AvaLogo, _AvaLogoPainter, build, paint, shouldRepaint (+18 more)
...
- **Why does `package:flutter/material.dart` connect `Community 0` to `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 12`, `Community 13`, `Community 14`?**
  _High betweenness centrality (0.199) - this node is a cross-community bridge._
- **Why does `dart:convert` connect `Community 4` to `Community 0`, `Community 3`, `Community 5`, `Community 6`?**
  _High betweenness centrality (0.198) - this node is a cross-community bridge._
- **Why does `Text` connect `Community 2` to `Community 1`, `Community 7`?**
