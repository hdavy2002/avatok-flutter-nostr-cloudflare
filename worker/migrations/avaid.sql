...
-- Current verification state per identity (npub). One row per user.
...
CREATE INDEX IF NOT EXISTS idx_verif_attempts_npub ON verification_attempts(npub, created_at);
