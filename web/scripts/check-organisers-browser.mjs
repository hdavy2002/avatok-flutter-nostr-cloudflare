...
export async function checkOrganisersBrowser(browser) {
  for (const [name, width, height] of [['wide',2560,1400],['desktop',1440,1000],['tablet',820,1000],['mobile',390,844],['small-mobile',320,740]]) {
    ...
    for (const label of ['All pujas','Grievance Redressal','Refund policy','Contact']) assert(await page.locator('footer').getByRole('link', {name:label,exact:true}).isVisible(), name + ': complete footer ' + label);
