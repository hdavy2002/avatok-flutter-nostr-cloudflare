...
assert.equal(meta(html, 'og:title'), 'avaTOK: paid live streams and 1:1 video calls with your favourite creators');
assert.equal(meta(html, 'og:description'), 'YouTube, Instagram and Facebook creators sell tickets to live streams and 1:1 video calls on avaTOK. Pay securely in rupees.');
