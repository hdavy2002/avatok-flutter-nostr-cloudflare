...
description: "How web sign-up works on saathum.com — an email code plus an Indian mobile OTP — and why onboarding and your Saathum number happen in the app."
section: getting-started
order: 2
updated: 2026-09-11
keywords: ["sign up", "signup", "create account", "otp", "email code", "verification", "account banao", "phone number", "saathum number"]
audience: both
faq:
  ...
  - q: "Do I get my Saathum number when I sign up on the web?"
    a: "No. Web sign-up creates your account; choosing your Saathum number and the rest of onboarding happen the first time you open the Saathum app."
  - q: "Why does Saathum need my real phone number if it stays private?"
    a: "It's used to verify you're a real person and to secure your account — everyone else only ever sees your Saathum number, never your real one."
draft: false
---
...
Verifying a real mobile number is how Saathum confirms you're a genuine person and secures your account against takeover. It is never shown to anyone else. Once you're through onboarding in the app, your public identity to other users is a separate **Saathum number** that keeps your real one masked.
...
Use [sign in](/sign-in) instead — the same email-code verification applies there too, since there are no passwords on Saathum.
