...
description: How to set a price for a live show or 1:1 session, and how that price is shown to buyers.
section: creators
order: 3
updated: 2026-09-11
keywords: ["price", "tokens", "minimum price", "per hour pricing", "free listing", "how much to charge", "rupees"]
audience: creator
faq:
...
There's a "this is a free show" option in the listing wizard, but as things stand it's restricted to test accounts. On a regular creator account, turning it on and trying to publish will be refused — you'll need to set a price to go live.
...
You can edit a listing's price after it's published, the same way you'd edit any other detail from [My listings](/dashboard/listings). Enter a whole number of tokens — the server always rounds down to the nearest whole token, so there's no such thing as a fractional price.
