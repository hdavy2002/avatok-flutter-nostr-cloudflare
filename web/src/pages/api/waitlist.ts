...
function welcomeHtml(): string {
  ...
  <div style="background:#f7f3ea;padding:30px 16px;font-family:Arial,Helvetica,sans-serif;color:#25211b;">
    ...
    <p style="max-width:520px;margin:16px auto 0;text-align:center;font-size:12px;color:#9a9684;line-height:1.5;">avaTOK · Dehradun, Uttarakhand, India.<br/>You received this because you joined the waitlist at avatok.ai.</p>
  </div></body></html>`;
}
