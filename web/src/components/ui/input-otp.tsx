  ...
  ({ index, className, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'relative flex h-12 w-11 items-center justify-center border-y border-r border-input bg-card font-dash text-lg font-bold shadow-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md',
