...
/* ── The bazaar palette ──────────────────────────────────────────────────────
 * Lifted verbatim from design/live-streaming/Saa Thum Marketplace.dc.html (the
 ...
 * with the design from design/live-streaming/Saa Thum Marketplace.dc.html: 3px ink
    ...
    >
      ...
      <div style={{ padding: '15px 17px 17px', display: 'flex', flexDirection: 'column', gap: 11, flex: 1 }}>
        ...
        <div style={{
          ...
          <span className="truncate">{language ?? uiT("web-common.35fd151dd99b83c6","SAA THUM")}</span>
        </div>
        ...
        <div style={{
          ...
          <span style={{ fontSize: '0.8125rem', fontWeight: 600, color: textCol }} className="truncate">
            {c.creator?.name ?? (c.creator?.handle ? `@${c.creator.handle}` : uiT("web-common.ee1d5e5358dcacd0","Saa Thum"))}
