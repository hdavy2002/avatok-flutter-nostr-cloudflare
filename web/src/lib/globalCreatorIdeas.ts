export const globalCreatorIdeas = [
  ...
  { slug: 'close-friends-studio', platform: 'Instagram', title: 'Close friends studio', description: 'Give your inner circle a dedicated room and your undivided time.', color: 'teal', eyebrow: 'GO 1:1' },
...
export const globalCreatorGuides: Record<GlobalCreatorIdeaSlug, CreatorGuide> = {
  'creator-watch-party': {
    ...
    invitation: 'Watch my latest film with me: 45 minutes of behind-the-scenes stories, three scenes unpacked and audience Q&A. This is a live discussion, not a 1:1 coaching session.',
  ...
  'close-friends-studio': {
    ...
    invitation: 'A 30-minute look inside my styling process. Pick one topic—colour, layering or building a moodboard—and we will explore it together. Custom designs and ongoing messaging are not included.',
    boundaries: ['“Close friends” describes the intimate format, not a friendship, romantic relationship or an Instagram product integration.', 'Agree on recording and screenshots before starting. Keep personal contact details and your physical studio location confidential.'],
  ...
  'ask-me-anything-1-1': {
    ...
    duration: '20-minute 1:1',
    introduction: 'An AMA works best when “anything” has a useful frame. Invite questions about your public work, creative routine or a shared interest. A short 1:1 session can feel genuinely personal without promising friendship, access to your personal life or specialist advice you are not qualified to give.',
    ...
    boundaries: ['Do not present a fan conversation as therapy, medical, financial or legal advice. Redirect questions outside your expertise.', 'No recording, screenshots or sharing of the conversation without the required consent. Follow platform safety rules and age requirements.'],
  ...
  'taste-of-your-world': {
    ...
    preparation: ['Choose one clearly named topic. A recipe conversation, language practice and a craft lesson require different expectations and materials.', 'Ask what the guest hopes to learn and which language you will use. Share an optional ingredient or materials list in advance if needed.', 'Prepare a small object, photograph or demonstration you have permission to share. Keep your home location and other people’s personal stories off camera.'],
    agenda: [
