export const globalCreatorIdeas = [
  ...
  { slug: 'launch-night-live', platform: 'YouTube + TikTok', title: 'Launch-night live', description: 'Bring your audience together for a premiere, drop, or special announcement.', color: 'orange', eyebrow: 'GO LIVE' },
...
export const globalCreatorGuides: Record<GlobalCreatorIdeaSlug, CreatorGuide> = {
  'creator-watch-party': {
    ...
    invitation: 'Watch my latest film with me: 45 minutes of behind-the-scenes stories, three scenes unpacked and audience Q&A. This is a live discussion, not a one-on-one coaching session.',
  ...
  'channel-coaching': {
    ...
    duration: '45-minute 1:1 session',
  ...
  'ask-me-anything-1-1': {
    ...
    promise: 'Give one customer a thoughtful conversation with clear boundaries.',
    audience: 'Creators whose audience has questions about their craft, journey or creative choices.',
    duration: '20-minute 1:1 session',
    introduction: 'An AMA works best when “anything” has a useful frame. Invite questions about your public work, creative routine or a shared interest. A short session can feel genuinely personal without promising ongoing access to your personal life or specialist advice you are not qualified to give.',
    ...
    boundaries: ['Do not present a customer conversation as therapy, medical, financial or legal advice. Redirect questions outside your expertise.', 'No recording, screenshots or sharing of the discussion without the required consent. Follow platform safety rules and age requirements.'],
  ...
  'taste-of-your-world': {
    ...
    duration: '30-minute 1:1 session',
