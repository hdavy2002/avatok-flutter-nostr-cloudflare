...
const DEFAULTS: Record<ListingFlavor, ListingContentDefaults> = {
  music: {
    ...
    houseRulesIntro: 'A small, relaxed hangout — no problem if you’re out of tune, the main thing is having fun.',
    houseRules: [
    ...
    faq: [
      { q: 'Do I need to sing well?', a: 'Not at all — this is for fun, not a competition. However you sing, a good time is guaranteed.' },
  ...
  comedy: {
    ...
    houseRulesIntro: 'This is a comedy show, and roasting might happen — bring a bit of thick skin.',
    houseRules: [
  ...
  quiz: {
    ...
    houseRulesIntro: 'Play fair, have fun — no Googling the answers!',
    houseRules: [
  ...
  fitness: {
    ...
    houseRulesIntro: 'Listen to your body — push yourself, but stay within your own limits.',
    houseRules: [
  ...
  ai_bestie: {
    ...
    houseRulesIntro: 'Always here whenever you want to talk — but there are some things it cannot do.',
    houseRules: [
    ...
    faq: [
      ...
      { q: 'Is it available at night?', a: 'Yes, 24/7 — it never sleeps, so it is always available.' },
