...
export const SUB_CATEGORIES: SubCategory[] = [
  ...
  { id: "group_language_practice", label: "Language practice", emoji: "🗣️", group: "find_your_people", sort: 330, hidden: true, },
  { id: "group_fitness_batch", label: "Fitness & yoga batch", emoji: "🧘", group: "find_your_people", sort: 340, hidden: true, },
  { id: "group_exam_revision", label: "Exam revision", emoji: "📖", group: "find_your_people", sort: 350, hidden: true, },
  { id: "group_music_class", label: "Music class", emoji: "🎵", group: "find_your_people", sort: 360, hidden: true, },
  { id: "group_cooking_class", label: "Cooking class", emoji: "🍳", group: "find_your_people", sort: 370, hidden: true, },
