  ...
  return (
    <form className="auth-form" onSubmit={onSubmitEmail} noValidate>
      ...
      <div className="auth-foot">
        <p className="auth-aside"><UiText id="web-auth.147f03f49b15afba" source="Ready for a break?" /><br /><UiText id="web-auth.eef3540404312d17" source="We'll have you set up in a moment." /></p>
