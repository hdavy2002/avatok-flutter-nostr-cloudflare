  ...
  return createPortal(
    <div className="ro-scrim" role="dialog" aria-modal="true" aria-labelledby="ro-title">
      <div className="ro-card">
        <p className="ro-kicker"><UiText id="web-dashboard.721feaa18450b1e6" source="Welcome to Saa Thum" /></p>
        <h2 className="ro-title" id="ro-title"><UiText id="web-dashboard.74e492d5d0df0bab" source="Before you start" /></h2>

        <p className="ro-lead"><UiText id="web-dashboard.0cbbe6459d3b69c9" source="Saa Thum is a creator marketplace for paid live events, private 1:1 sessions and AI voice agents. Thank you for taking the time to review it." />{" "}</p>

        <ul className="ro-list">
          <li>
            <strong><UiText id="web-dashboard.63daeb29abfbc2cc" source="We are an early-stage startup." /></strong>{" "}<UiText id="web-dashboard.aac0944d09bd4cd8" source="Saa Thum is built and operated by an independent founding team in India. We are currently an" />{' '}
        ...
        <p className="ro-foot"><UiText id="web-dashboard.20c3460dedcec159" source="Questions during your review?" />{" "}support (@) saathum.com{" "}<UiText id="web-dashboard.9ee6e0114bdad18a" source="· Mumbai, India" />{" "}</p>
      </div>
