...
function ExploreGridInner({
   ...
   * ?q=… was told "Nothing found, boss." about their own search before it ran.
   */
        ...
        <main className="min-w-0 flex-1">
          <div className="mb-8 flex flex-wrap items-center gap-3.5">
            ...
            <span className="font-label text-[0.8125rem] font-extrabold uppercase tracking-[0.12em] text-ink">
              {loaded
                ? uiT("web-marketplace.e464441e0b11cb75","{value0} {value1} · Whole bazaar",{value0:String(items.length),value1:String(items.length === 1 ? 'listing' : 'listings')})
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 rounded-[22px] border-zine border-dashed border-ink bg-card px-7 py-10 text-center">
              <div className="grid h-[104px] w-[104px] flex-none -rotate-[8deg] place-items-center rounded-full border-zine border-dashed border-coral">
                <span className="font-label text-[0.6875rem] font-extrabold uppercase leading-[1.7] tracking-[0.06em] text-coral">
                  {narrowed ? (<><UiText id="web-marketplace.b5b9eb055f3f31f8" source="Bad" /><br /><UiText id="web-marketplace.6c1c6e85669fb48c" source="luck" /><br />· 404 ·</>) : (<><UiText id="web-marketplace.4e6b8f6a7f14abf9" source="Bazaar" /><br /><UiText id="web-marketplace.50be7504b658cd6f" source="opening" /><br /><UiText id="web-marketplace.739b9d664d77db3e" source="up" /></>)}
                </span>
              </div>
