...
function ActivityDetail({ row, detail, failed }: { row: Tx; detail: Activity | null; failed: boolean }) {
  ...
  return (
    <div className="px-4 pb-3 pt-1">
      ...
      <DetailRow label={uiT("web-dashboard.49e96d7cdf58069c","Amount")}>{tokens >= 0 ? '+' : ''}{tokens.toLocaleString()}{" "}<UiText id="web-dashboard.22c9ec4e54e610a0" source="tokens (₹" />{Math.abs(tokens).toLocaleString('en-IN')})</DetailRow>
