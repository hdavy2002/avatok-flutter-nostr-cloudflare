    ...
    <div className="flex flex-col gap-5">
      {draft.free_entry ? (
        ...
        <>
          ...
          {price > 0 && (
            <Card fillClassName="bg-paper2">
              <p className="font-body font-bold text-[13px] text-ink"><UiText id="web-dashboard.e786406a7cf2b9c2" source="At ₹" />{price}<UiText id="web-dashboard.c1409f8795a2bad6" source="/hr, Saa Thum takes ₹" />{split.fee}{" "}<UiText id="web-dashboard.65fb17d22dac7abf" source="and you keep ₹" />{split.creator}.
              </p>
              ...
              <table className="w-full font-body text-[13px]">
                <thead>
                  <tr className="border-b-2 border-ink bg-paper2 text-left">
                    ...
                    <th className="p-2 font-mono font-bold uppercase text-[11px] tracking-[0.06em] text-inkSoft"><UiText id="web-dashboard.b39e0d8f2996036f" source="Saa Thum takes" /></th>
          ...
          {/* [WIZ-DISCOUNT-1] What the CUSTOMER pays, live. The step showed only
              ...
              for ₹250 and keep ₹205. Saa Thum's fee is charged on the DISCOUNTED
          ...
          {price > 0 && (earlyPrice !== null || promoPrice !== null) && (
            <div>
              ...
              <p className="mt-1 font-body text-[12px] text-inkSoft"><UiText id="web-dashboard.89c2a84ef6b263b0" source="Saa Thum’s ₹" />{PRICING.flatTokensPerHour}{" "}<UiText id="web-dashboard.2029b52b55f9a44b" source="flat +" />{" "}{PRICING.commissionPct}<UiText id="web-dashboard.f4a9ae34a26c3254" source="% is taken from what the customer actually pays, so a discount comes out of both sides — not only yours." />{" "}</p>
            </div>
          )}
        </>
      )}
