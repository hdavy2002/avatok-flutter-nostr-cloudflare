...
// [UI-ZINE-SPLIT-1 2026-08-05] `ZineWidthClass` + `ZineBreakpoints` MOVED OUT
// of this file to `core/ui/breakpoints.dart`. They are layout utilities with
// nothing to do with colour, and keeping them here forced every screen that
// wanted a responsive gutter to import the whole light palette — which is how
// `Zine.*` kept leaking back into screens already migrated to `AD`. The class
// names are unchanged; import `breakpoints.dart` instead.
