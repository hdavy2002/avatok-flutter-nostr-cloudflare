/// A marketplace listing (AvaExplore). Static now; backend-wired later.
class Product {
  final String title;
  final String author;
  final String price;
...
const kProducts = <Product>[
  ...
  Product(title: 'Ava Dev Starter Kit', author: 'alexc', price: 'Free', rating: '5.0', category: 'Templates', gradient: 1, sold: 3100),
