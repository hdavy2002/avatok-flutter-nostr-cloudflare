...
/// Listing detail — product page with hero, description, and Buy now.
class ListingDetail extends StatelessWidget {
          ...
          children: [
            Padding(
              ...
              child: Row(
                children: [
                  IconButton(
                    icon: const Icon(Icons.arrow_back, color: AvaColors.ink),
                    onPressed: () => Navigator.pop(context),
                  ),
                  Text('Listing', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontSize: 18)),
                  const Spacer(),
                  const Icon(Icons.notifications_none_rounded, color: AvaColors.ink, size: 22),
                  const SizedBox(width: 16),
                  const Icon(Icons.mail_outline, color: AvaColors.ink, size: 22),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(product.title,
                        style: Theme.of(context).textTheme.displayLarge?.copyWith(fontSize: 26, height: 1.15)),
                    ...
                    const Text(
                      'A hand-crafted creator product delivered instantly to your AvaTOK store. '
                    ...
                    Container(
                      ...
                      child: const Row(children: [
                        Icon(Icons.bolt, color: AvaColors.brand, size: 20),
                        SizedBox(width: 10),
                        Text('Instant delivery to your library',
  ...
  Widget _buyBar(BuildContext context) => Container(
