                  ...
                  children: [
                    ...
                    if (s == null)
                      Padding(padding: const EdgeInsets.all(24), child: Center(
                          child: UiText(UiMessage.m_no_stats_yet_they_appear_923b1e474c,
                      ...
                      ZineCard(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Text(a.isFreeForCallers
                              ? uiCopy(UiMessage.m_sponsored_agent_callers_talk_free_ac106b968b)
                    ...
                    UiText(
                      UiMessage.m_you_ll_also_get_a_61e94c6e5b,
