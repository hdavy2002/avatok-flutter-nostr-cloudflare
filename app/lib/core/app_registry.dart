...
final kAppRegistry = <AppEntry>[
  ...
  AppEntry(
      ...
      const Color(0xFF08C4C4)),
  AppEntry(
      'virtual_numbers',
      'Virtual Numbers',
      'Numbers, inboxes & receptionists',
      PhosphorIcons.phoneList(PhosphorIconsStyle.regular),
      // [DESIGN-GUARD-DEBT-2] Was a raw 0xFFE9A227, which is exactly AD.haldi.
      // The rest of this table is third-party BRAND hues (Instagram, YouTube,
      // LinkedIn…) that legitimately cannot be tokens; this one is our own
      // marigold and had no reason to be a literal.
      AD.haldi),
  AppEntry(
      'avalibrary',
      'Library',
  ...
  AppEntry('avawallet', 'Wallet', 'Tokens & top-ups',
      PhosphorIcons.wallet(PhosphorIconsStyle.regular), const Color(0xFF10B981),
      tier: AppTier.hidden),
  ...
  AppEntry(
      ...
      const Color(0xFFFF6036),
      tier: AppTier.hidden),
  AppEntry('verse', 'AvaVerse', 'Your dashboard',
      PhosphorIcons.gauge(PhosphorIconsStyle.regular), const Color(0xFF6C5CE7),
      tier: AppTier.hidden),
  AppEntry('avapayout', 'AvaPayout', 'Withdraw your earnings',
      PhosphorIcons.money(PhosphorIconsStyle.regular), const Color(0xFF0A66C2),
      tier: AppTier.hidden),
  ...
  AppEntry(
      ...
      const Color(0xFFA06AF0),
      tier: AppTier.hidden),
  AppEntry('avavision', 'AvaVision', 'AI vision coaches',
      PhosphorIcons.eye(PhosphorIconsStyle.regular), const Color(0xFFA06AF0),
      tier: AppTier.hidden),
  AppEntry('avainbox', 'AvaInbox', 'All messages, one inbox',
      PhosphorIcons.tray(PhosphorIconsStyle.regular), const Color(0xFF4F8DFD),
      tier: AppTier.hidden),
  AppEntry(
      'avaaffiliate',
      'AvaAffiliate',
      'Earn 10% for life',
      PhosphorIcons.megaphone(PhosphorIconsStyle.regular),
  ...
  AppEntry(
      ...
      tier: AppTier.hidden),
  AppEntry('avatweet', 'AvaTweet', 'Microblog & timeline',
      PhosphorIcons.hash(PhosphorIconsStyle.regular), const Color(0xFF1DA1F2),
      tier: AppTier.hidden),
  AppEntry(
      'avabook',
      'AvaBook',
      ...
      const Color(0xFF7C5CFC),
      tier: AppTier.hidden),
  AppEntry('avagram', 'AvaGram', 'Photos & stories',
      PhosphorIcons.camera(PhosphorIconsStyle.regular), const Color(0xFFE1306C),
      tier: AppTier.hidden),
  AppEntry('avaweb', 'AvaWeb', 'AI website builder',
      PhosphorIcons.globe(PhosphorIconsStyle.regular), const Color(0xFF10B981),
      tier: AppTier.hidden),
  AppEntry('avanote', 'AvaNote', 'Notes & ideas',
      PhosphorIcons.note(PhosphorIconsStyle.regular), const Color(0xFFEAB308),
      tier: AppTier.hidden),
  AppEntry(
      'avatube',
      'AvaTube',
      'Long-form video',
      PhosphorIcons.monitorPlay(PhosphorIconsStyle.regular),
      const Color(0xFFFF0000),
      tier: AppTier.hidden),
  AppEntry('avaads', 'AvaAds', 'Promote & advertise',
      PhosphorIcons.tag(PhosphorIconsStyle.regular), const Color(0xFFFF5864),
      tier: AppTier.hidden),
  AppEntry(
      'avalinked',
      'AvaLinked',
      ...
      tier: AppTier.hidden),
  AppEntry('avatind', 'AvaTind', 'Meet & match',
      PhosphorIcons.fire(PhosphorIconsStyle.regular), const Color(0xFFFF6036),
      tier: AppTier.hidden),
  AppEntry('avamatri', 'AvaMatri', 'Find your partner',
      PhosphorIcons.heart(PhosphorIconsStyle.regular), const Color(0xFFB91C4B),
      tier: AppTier.hidden),
];
...
class AppRegistry {
  ...
  static List<AppEntry> get standard => kAppRegistry
      .where((a) => a.tier == AppTier.standard && _visible(a))
      .toList();
  ...
  static List<AppEntry> get focusMode => kAppRegistry
      .where((a) => _focusIds.contains(a.id) && _visible(a))
      .toList();
}
