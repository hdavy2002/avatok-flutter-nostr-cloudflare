...
const List<ListingGroup> kListingGroups = [
  ...
  ListingGroup(
    ...
    kinds: ['consult'],
    sections: ['live_friends', 'adda_rooms', 'group_classes'],
  ),
  ListingGroup(
    id: 'book_their_time',
...
const Set<String> kHiddenListingSections = {'adda_rooms', 'ai_voice_agents', 'consulting', 'glow_up', 'live_friends'};
...
const List<ListingSubCategory> kListingSubCategories = [
  ListingSubCategory(id: 'live_cooking', label: 'Cooking', emoji: '🍳', group: 'india_goes_live', sort: 10, hidden: true,),
  ListingSubCategory(id: 'live_trek', label: 'Treks & hiking', emoji: '🥾', group: 'india_goes_live', sort: 20, hidden: true,),
  ListingSubCategory(id: 'live_puja', label: 'Puja & darshan', emoji: '🪔', group: 'india_goes_live', sort: 30,),
  ListingSubCategory(id: 'live_puja_ritual', label: 'Puja', emoji: '🕉️', group: 'india_goes_live', sort: 35,),
  ...
  ListingSubCategory(id: 'live_music', label: 'Music', emoji: '🎵', group: 'india_goes_live', sort: 60, hidden: true,),
  ListingSubCategory(id: 'live_dance', label: 'Dance', emoji: '💃', group: 'india_goes_live', sort: 70, hidden: true,),
  ListingSubCategory(id: 'live_travel', label: 'Travel & road trips', emoji: '🛵', group: 'india_goes_live', sort: 80, hidden: true,),
  ListingSubCategory(id: 'live_food_walk', label: 'Street food walks', emoji: '🍜', group: 'india_goes_live', sort: 90, hidden: true,),
  ListingSubCategory(id: 'live_fitness', label: 'Yoga & fitness', emoji: '🧘', group: 'india_goes_live', sort: 100, hidden: true,),
  ListingSubCategory(id: 'live_sports', label: 'Sports', emoji: '🏏', group: 'india_goes_live', sort: 110, hidden: true,),
  ListingSubCategory(id: 'live_art', label: 'Art & craft', emoji: '🎨', group: 'india_goes_live', sort: 120, hidden: true,),
  ListingSubCategory(id: 'live_satsang', label: 'Satsang & sermons', emoji: '📿', group: 'india_goes_live', sort: 130,),
  ListingSubCategory(id: 'live_everyday', label: 'Everyday life', emoji: '☕', group: 'india_goes_live', sort: 140, hidden: true,),
  ...
  ListingSubCategory(id: 'group_language_practice', label: 'Language practice', emoji: '🗣️', group: 'find_your_people', sort: 330, hidden: true,),
  ListingSubCategory(id: 'group_fitness_batch', label: 'Fitness & yoga batch', emoji: '🧘', group: 'find_your_people', sort: 340, hidden: true,),
  ListingSubCategory(id: 'group_exam_revision', label: 'Exam revision', emoji: '📖', group: 'find_your_people', sort: 350, hidden: true,),
  ListingSubCategory(id: 'group_music_class', label: 'Music class', emoji: '🎵', group: 'find_your_people', sort: 360, hidden: true,),
  ListingSubCategory(id: 'group_cooking_class', label: 'Cooking class', emoji: '🍳', group: 'find_your_people', sort: 370, hidden: true,),
  ListingSubCategory(id: 'astrologers', label: 'Astrologers', emoji: '🔮', group: 'book_their_time', sort: 410,),
  ListingSubCategory(id: 'palmistry', label: 'Palmistry', emoji: '🤲', group: 'book_their_time', sort: 411,),
  ListingSubCategory(id: 'tarot_reading', label: 'Tarot reading', emoji: '🃏', group: 'book_their_time', sort: 412,),
  ListingSubCategory(id: 'numerology', label: 'Numerology', emoji: '🔢', group: 'book_their_time', sort: 413,),
  ListingSubCategory(id: 'kundli_matching', label: 'Kundli matching', emoji: '💑', group: 'book_their_time', sort: 414,),
  ListingSubCategory(id: 'vastu', label: 'Vastu', emoji: '🧭', group: 'book_their_time', sort: 415,),
  ListingSubCategory(id: 'pandit_consultation', label: 'Pandit consultation', emoji: '🙏', group: 'book_their_time', sort: 416,),
  ListingSubCategory(id: 'meditation', label: 'Meditation', emoji: '🧘', group: 'book_their_time', sort: 417,),
  ListingSubCategory(id: 'teachers', label: 'Tutors & teachers', emoji: '📚', group: 'book_their_time', sort: 420, hidden: true,),
  ListingSubCategory(id: 'professors', label: 'Professors', emoji: '🎓', group: 'book_their_time', sort: 430, hidden: true,),
  ListingSubCategory(id: 'business', label: 'Business & startups', emoji: '💼', group: 'book_their_time', sort: 440, hidden: true,),
  ListingSubCategory(id: 'money_finance', label: 'Money & finance', emoji: '💰', group: 'book_their_time', sort: 450, hidden: true,),
  ListingSubCategory(id: 'career_coach', label: 'Career coaching', emoji: '🧭', group: 'book_their_time', sort: 460, hidden: true,),
  ListingSubCategory(id: 'fitness', label: 'Fitness coaching', emoji: '💪', group: 'book_their_time', sort: 470, hidden: true,),
  ListingSubCategory(id: 'wellness', label: 'Wellness', emoji: '🧘', group: 'book_their_time', sort: 480, hidden: true,),
  ListingSubCategory(id: 'music', label: 'Music lessons', emoji: '🎵', group: 'book_their_time', sort: 490, hidden: true,),
  ListingSubCategory(id: 'language', label: 'Language lessons', emoji: '🗣️', group: 'book_their_time', sort: 500, hidden: true,),
  ListingSubCategory(id: 'art', label: 'Art & design', emoji: '🎨', group: 'book_their_time', sort: 510, hidden: true,),
  ListingSubCategory(id: 'glow_up', label: 'Style & glow-up', emoji: '✨', group: 'book_their_time', sort: 520, hidden: true,),
  ListingSubCategory(id: 'legal_tax', label: 'Legal & tax', emoji: '⚖️', group: 'book_their_time', sort: 530, hidden: true,),
  ListingSubCategory(id: 'tech_help', label: 'Tech help', emoji: '🛠️', group: 'book_their_time', sort: 540, hidden: true,),
  ListingSubCategory(id: 'services', label: 'Other professional', emoji: '🔧', group: 'book_their_time', sort: 550, hidden: true,),
];
