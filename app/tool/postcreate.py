...
def patch_signing() -> None:
    ...
    # R8 keep/dontwarn rules. The Flutter Gradle plugin runs R8 on release builds
    # regardless of --no-shrink, and flutter_stripe (in-app PaymentSheet) bundles
    # react-native-stripe-sdk classes that reference OPTIONAL Stripe
    # push-provisioning APIs the app never uses. Without these rules R8 aborts
    # with "Missing classes detected while running R8". This is the documented
    # flutter_stripe Android ProGuard fix. Also keep WebRTC/LiveKit native bridges.
    proguard = APP / "android/app/proguard-rules.pro"
    proguard.write_text(
        "# Auto-generated by tool/postcreate.py — do not edit the generated copy.\n"
        ...
        "# classpath, so silence the missing-class errors.\n"
