...
| 1.7 | 2026-08-02 | **PERMANENT FREE COMMUNICATION RULE (owner decision):** human chat messaging, 1:1 audio/video calls, and AvaTalk group audio/video conferences up to 25 participants are free and unlimited on every account/tier. No escrow, per-minute charge, wallet gate, paid-call rate, conference-minute quota, or tier-based conference size. AI agents/receptionist, PSTN, translation, storage overage, paid events, and other provider-backed services keep separate pricing. |
...
16. **Human communication is permanently free.** Human chat messaging, 1:1 audio/video calls, and AvaTalk group audio/video conferences (≤25) have no charge, wallet/balance gate, escrow, daily minute quota, or subscription-tier participant limit. Do not confuse human communication with AI/PSTN/provider-backed products, which keep their own explicit pricing.
